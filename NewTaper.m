...
% Being based on an old C program, this function could be re-written
%   substanitally to be much more efficient!
% Vs 3.0 -- April 2009
%   extend operation to stereo waveforms
% Vs 2.0 -- January 2003
...
if nargin<4
    error('Insufficient number of arguments. Type "help NewTaper" for more information.');
elseif nargin<5
    type='cosine';
end
...
elseif strcmp(type,'linear')
    ...
    error('rise/fall type must be "linear" or "cosine". Type "help NewTaper" for more information.');
end
